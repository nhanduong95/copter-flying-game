...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(StaticValues.SCREEN_WIDTH, StaticValues.SCREEN_HEIGHT));
    }
    ...
    /**
     * This must be called in ApplicationListener.resize() in order to correctly updateObjects the camera viewport.
     */
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(StaticValues.SCREEN_WIDTH, StaticValues.SCREEN_HEIGHT);
